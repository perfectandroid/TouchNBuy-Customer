...
public class ContactUsActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener,
    ...
    TextView feedBack,rateUs, aboutUs,privacyPolicy,termsAndCondition,aboutUsDescription,privacyPolicyDescription,
            termsAndConditionDescription,tvuser, tvcart, tv_notification, faq_description, faq,tv_header,txtvcontact,tv_technlgy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with( this ).load( R.drawable.contactusgif ).into( imbanner );
       ...
       /* if(RequiredStorepref.getString("RequiredStore", null).equals("false")&&RequiredShoppinglistpref.getString("RequiredShoppinglist", null).equals("false")){
        ...
        SharedPreferences aboutus = getApplicationContext().getSharedPreferences(Config.SHARED_PREF_CONTACT_US, 0);
        about_us_value = aboutus.getString("ContactDetails",null);
        if (about_us_value!=null) {
            tv_about_us.setText(about_us_value);
        }

        SharedPreferences pref4 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF230, 0);
        tv_header.setText(pref4.getString("contactus", null));

        SharedPreferences pref5 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF230, 0);
        txtvcontact.setText(pref5.getString("contactus", null));
    ...
    private void initiateViews() {
        ...
        txtvcontact  =(TextView) findViewById(R.id.txtvcontact);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.etSearch:
                ...
                break;
            case R.id.imcart:
                Intent in = new Intent(ContactUsActivity.this, CartActivity.class);
                in.putExtra("From", "Home");
                startActivity(in);
                break;
            case R.id.tvcart:
                Intent i = new Intent(ContactUsActivity.this, CartActivity.class);
            ...
            case R.id.feedback:
                try {
                    ...
                    LayoutInflater inflater1 = (LayoutInflater) ContactUsActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ContactUsActivity.this, android.R.layout.simple_spinner_item, categories);
    ...
    private void setHomeNavMenu() {
        ...
        NavMenuAdapter adapter = new NavMenuAdapter(ContactUsActivity.this, menulist, imageId);
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(ContactUsActivity.this, OrdersActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 3) {
                    startActivity(new Intent(ContactUsActivity.this, FavouriteActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }  else if (position == 4) {
                    startActivity(new Intent(ContactUsActivity.this, FavouriteStoreActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 5) {
                    startActivity(new Intent(ContactUsActivity.this, NotificationActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 6) {
                    startActivity(new Intent(ContactUsActivity.this, ShoppingListActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }else if (position == 7) {
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(ContactUsActivity.this, TermsnConditionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 12) {
                    startActivity(new Intent(ContactUsActivity.this, PrivacyActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 13) {
                    startActivity(new Intent(ContactUsActivity.this, SuggestionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 14) {
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(getResources().getString(R.string.app_name).equals("JZT CART") || getResources().getString(R.string.app_name).equals("Pulikkottil Hypermarket") || getResources().getString(R.string.app_name).equals("NeethiMed")|| getResources().getString(R.string.app_name).equals("Touch n Buy")) {
                        ...
                        startActivity(new Intent(ContactUsActivity.this,SplashActivity.class));
                        finish();}
                    else{
                        startActivity(new Intent(ContactUsActivity.this,LocationActivity.class));
                        finish();}
    ...
    protected void sendEmail() {
        ...
        Toast.makeText(ContactUsActivity.this, Sendmail+"", Toast.LENGTH_SHORT).show();        String[] TO = {"touchnbuysupport@gmail.com"};
        ...
        public boolean onNavigationItemSelected( MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_category:
                    Intent io = new Intent(ContactUsActivity.this, OutShopActivity.class);
                ...
                case R.id.navigation_cart:
                    ...
                    Intent ic = new Intent(ContactUsActivity.this, CartActivity.class);
                ...
                case R.id.navigation_home:
                    ...
                    Intent iha = new Intent(ContactUsActivity.this, HomeActivity.class);
                    iha.putExtra(fromFavorite, valueFavorite);
                    startActivity(iha);
                    return true;
                case R.id.navigation_favorite:
                    Log.e(TAG,"navigation_favorite    ");
                    Intent ifa = new Intent(ContactUsActivity.this, FavouriteActivity.class);

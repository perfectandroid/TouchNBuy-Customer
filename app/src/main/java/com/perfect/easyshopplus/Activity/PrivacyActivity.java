...
public class PrivacyActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener,
    ...
    TextView  aboutUsDescription,privacyPolicyDescription,
            termsAndConditionDescription,tvuser, tvcart, tv_notification,tv_header,txtvprivacypolicy1;
   // TextView termsAndCondition,rateUs,aboutUs,privacyPolicy,feedBack,faq,faq_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with( this ).load( R.drawable.ppgif ).into( imbanner );
        initiateViews();
        setRegViews();
        setBottomBar();
        ...
        tv_header.setHint(pref4.getString("MobileNo", null));
...
//        }
        ...
        SharedPreferences pref44 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF231, 0);
        tv_header.setText(pref44.getString("privacypolicy", null));

        SharedPreferences pref45 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF231, 0);
        txtvprivacypolicy1.setText(pref44.getString("privacypolicy", null));
...
//        PicassoTrustAll.getInstance(this).load(strimagepath).into(imCompanylogo);
        ...
        SharedPreferences pref5 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF_PRIVACYPOLICY, 0);
        privacypolicy= pref5.getString("privacypolicy", null);
        Log.e("privacypolicy   ","privacypolicy   119   "+privacypolicy);
//
        if (privacypolicy!=null){
            text_pricacy_policy.setText(privacypolicy);
        }
    ...
    private void initiateViews() {
        ...
        txtvprivacypolicy1= (TextView) findViewById(R.id.txtvprivacypolicy1);
...
//        faq_description = (TextView) findViewById(R.id.faq_description);
        ...
        text_pricacy_policy = findViewById(R.id.text_pricacy_policy);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.im:
                ...
                onBackPressed();                break;
            case R.id.etSearch:
                startActivity(new Intent(PrivacyActivity.this,SearchActivity.class));
                break;
            case R.id.imcart:
                Intent in = new Intent(PrivacyActivity.this, CartActivity.class);
                in.putExtra("From", "Home");
                startActivity(in);
                break;
            case R.id.tvcart:
                Intent i = new Intent(PrivacyActivity.this, CartActivity.class);
                i.putExtra("From", "Home");
                startActivity(i);
                break;
            case R.id.tv_notification:
                startActivity(new Intent(PrivacyActivity.this, NotificationActivity.class));
                break;
            ...
            case R.id.feedback:
                try {
                    ...
                    LayoutInflater inflater1 = (LayoutInflater) PrivacyActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(PrivacyActivity.this, android.R.layout.simple_spinner_item, categories);
...
//                break;
    ...
    private void setHomeNavMenu() {
        ...
        NavMenuAdapter adapter = new NavMenuAdapter(PrivacyActivity.this, menulist, imageId);
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(PrivacyActivity.this, OrdersActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 3) {
                    startActivity(new Intent(PrivacyActivity.this, FavouriteActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }  else if (position == 4) {
                    startActivity(new Intent(PrivacyActivity.this, FavouriteStoreActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 5) {
                    startActivity(new Intent(PrivacyActivity.this, NotificationActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 6) {
                    startActivity(new Intent(PrivacyActivity.this, ShoppingListActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }else if (position == 7) {
                    startActivity(new Intent(PrivacyActivity.this, ProfileActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 8) {
                    doLogout();
                    drawer.closeDrawer(GravityCompat.START);
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(PrivacyActivity.this, ContactUsActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 10) {
                    ...
                    startActivity(new Intent(PrivacyActivity.this, TermsnConditionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 12) {
                    ...
                    startActivity(new Intent(PrivacyActivity.this, SuggestionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 14) {
                    startActivity(new Intent(PrivacyActivity.this, FAQActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
            }
        });
    ...
    private void doLogout() {
        try {
            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(PrivacyActivity.this);
            LayoutInflater inflater1 = (LayoutInflater) PrivacyActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(getResources().getString(R.string.app_name).equals("JZT CART") || getResources().getString(R.string.app_name).equals("Pulikkottil Hypermarket") || getResources().getString(R.string.app_name).equals("NeethiMed")|| getResources().getString(R.string.app_name).equals("Touch n Buy")) {
                        ...
                        startActivity(new Intent(PrivacyActivity.this,SplashActivity.class));
                        finish();}
                    else{
                        startActivity(new Intent(PrivacyActivity.this,LocationActivity.class));
                        finish();}
    ...
    protected void sendEmail() {
        ...
        Toast.makeText(PrivacyActivity.this, Sendmail+"", Toast.LENGTH_SHORT).show();
        String[] TO = {"touchnbuysupport@gmail.com"};
        ...
        public boolean onNavigationItemSelected( MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_category:
                    Intent io = new Intent(PrivacyActivity.this, OutShopActivity.class);
                ...
                case R.id.navigation_cart:
                    ...
                    Intent ic = new Intent(PrivacyActivity.this, CartActivity.class);
                ...
                case R.id.navigation_home:
                    ...
                    Intent iha = new Intent(PrivacyActivity.this, HomeActivity.class);
                    iha.putExtra(fromFavorite, valueFavorite);
                    startActivity(iha);
                    return true;
                case R.id.navigation_favorite:
                    Log.e(TAG,"navigation_favorite    ");
                    Intent ifa = new Intent(PrivacyActivity.this, FavouriteActivity.class);

...
public class LocationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btGetstarted;
    Spinner spinner;
    String strCountry,OK;
    TextView txtslctcountry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences pref4 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF83, 0);
        txtslctcountry.setText(pref4.getString("SelectYourCountry", null));

        SharedPreferences pref5 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF84, 0);
        btGetstarted.setText(pref5.getString("GetStarted", null));

        SharedPreferences OKsp = getApplicationContext().getSharedPreferences(Config.SHARED_PREF104, 0);
        OK = (OKsp.getString("OK", ""));

        List<String> countrylist = new ArrayList<>();
      //  countrylist.add(0, "Select a Country");
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (parent.getItemAtPosition(position).equals("Choose Country From List")){
                }else {
                    String item = parent.getItemAtPosition(position).toString();
                    SharedPreferences Selectedsp = getApplicationContext().getSharedPreferences(Config.SHARED_PREF371, 0);
                    String Selected = Selectedsp.getString("Selected","");
                    ...
                    CountryprefEditor.putString("country", item);
    ...
    private void initiateViews() {
        ...
        txtslctcountry=(TextView) findViewById(R.id.txtslctcountry);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btGetstarted:
                if(getResources().getString(R.string.app_name).equals("Shop Away")){
...
//                        BaseurlprefEditor.putString("BaseURL", "https://202.164.150.65:14001/TouchNBuyAPI/api/");//local
                        //BaseurlprefEditor.putString("BaseURL", "https://202.164.150.65:14001/TouchNBuyAPIQA/api/");
                        BaseurlprefEditor.putString("BaseURL", "https://demo.shopaway.shop/shopawayapi/api/");
                       // BaseurlprefEditor.putString("BaseURL", "https://web.shopaway.shop/shopawayapi/api/");
...
//                        BaseurlprefEditor.putString("BaseURL", "https://202.164.150.65:14001/TouchNBuyAPI/");//local
                        ImageurlprefEditor.putString("ImageURL", "https://demo.shopaway.shop/shopawayapi");
                       // ImageurlprefEditor.putString("ImageURL", "https://web.shopaway.shop/shopawayapi");
                        ImageurlprefEditor.commit();
                    }
                    if(strCountry.equals("Malaysia")) {
                        SharedPreferences Baseurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF56, 0);
                        SharedPreferences.Editor BaseurlprefEditor = Baseurlpref.edit();
                        BaseurlprefEditor.putString("BaseURL", "https://demo.shopaway.asia/shopawayapi/api/");
                      //  BaseurlprefEditor.putString("BaseURL", "https://web.shopaway.asia/shopawayapi/api/");
                        BaseurlprefEditor.commit();
                        SharedPreferences Imageurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF57, 0);
                        SharedPreferences.Editor ImageurlprefEditor = Imageurlpref.edit();
                        ImageurlprefEditor.putString("ImageURL", "https://demo.shopaway.asia/shopawayap");
                       // ImageurlprefEditor.putString("ImageURL", "https://web.shopaway.asia/shopawayap");
                        ImageurlprefEditor.commit();
                    }
                    getResellerDetails();

                }
                if(getResources().getString(R.string.app_name).equals("Touch n Buy")){
                    ...
                    if(strCountry.equals("India")) {
                       ...
                       // BaseurlprefEditor.putString("BaseURL", "https://40.81.77.56:14001/touchnbuyapilive/api/");
//                        BaseurlprefEditor.putString("BaseURL", "https://touchnbuy.perfectlimited.com/touchnbuyapilive/api/");
                        BaseurlprefEditor.commit();
                        SharedPreferences Imageurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF57, 0);
                        SharedPreferences.Editor ImageurlprefEditor = Imageurlpref.edit();
                      ...
                      //  ImageurlprefEditor.putString("ImageUaRL", "https://40.81.77.56:14001/touchnbuyapilive");
//                        ImageurlprefEditor.putString("ImageURL", "https://touchnbuy.perfectlimited.com/touchnbuyapilive");
                        ImageurlprefEditor.commit();
                ...
                if(getResources().getString(R.string.app_name).equals("Pulikkottil Hypermarket")){

                    if(strCountry.equals("India")) {
                        SharedPreferences Baseurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF56, 0);
                        SharedPreferences.Editor BaseurlprefEditor = Baseurlpref.edit();
                       //BaseurlprefEditor.putString("BaseURL", "https://202.164.150.65:14001/TouchNBuyAPIQA/api/");
                        BaseurlprefEditor.putString("BaseURL", "https://103.66.76.111:14002/touchnbuyapi/api/");
                        BaseurlprefEditor.commit();
                        SharedPreferences Imageurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF57, 0);
                        SharedPreferences.Editor ImageurlprefEditor = Imageurlpref.edit();
                        //ImageurlprefEditor.putString("ImageURL", "https://202.164.150.65:14001/TouchNBuyAPIQA");
                        ImageurlprefEditor.putString("ImageURL", "https://103.66.76.111:14002/touchnbuyapi");
                        ImageurlprefEditor.commit();
...
//                        BaseurlprefEditor.putString("BaseURL", "https:/202.21.32.35:85/touchnbuyapi/api/");
//                        BaseurlprefEditor.putString("BaseURL","https://103.66.76.111:14002/touchnbuyapi/api/");//liTouchNBuyAPIve
...
//                        ImageurlprefEditor.putString("ImageURL", "https://202.21.32.35:85/touchnbuyapi");
//                        ImageurlprefEditor.putString("ImageURL", "https://103.66.76.111:14002/touchnbuyapi");//live
//                  ImageurlprefEditor.putString("ImageURL", "https://40.81.77.56:93/justcartAPI");//justcart live
               ...
               /* else {
                    SharedPreferences Baseurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF56, 0);
                    SharedPreferences.Editor BaseurlprefEditor = Baseurlpref.edit();
                    BaseurlprefEditor.putString("BaseURL", "web.shopaway.shop/shopawayapi/api/");
                    BaseurlprefEditor.commit();
                    SharedPreferences Imageurlpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF57, 0);
                    SharedPreferences.Editor ImageurlprefEditor = Imageurlpref.edit();
                    ImageurlprefEditor.putString("ImageURL", "https://web.shopaway.shop/shopawayapi");
                ...
                call.enqueue(new Callback<String>() {
                    @Override public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                        try {
                            ...
                            Log.e(TAG,"onResponse   284   "+response.body());
...
//                                startActivity(new Intent(LocationActivity.this,WelcomeActivity.class));
//                                finish();
                            }
                            else{
                        ...
                        try {
                            ...
                            if(jObject.getString("StatusCode").equals("0")) {
                                ...
                                if(ID_Languages.getString("ID_Languages", null) == null){
                                    ...
                                    Log.e(TAG,"onResponse  194  "+jsonObject.getString("ID_Languages"));
                                }
            ...
            try{
                ...
                try {
                    ...
                    if (IDLanguages.getString("ID_Languages", null) == null){
                        ...
                        Log.e(TAG,"ID_Languages  209  "+IDLanguages.getString("ID_Languages", null));
                        requestObject1.put("ID_Languages",IDLanguages.getString("ID_Languages", null));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
...
//                                ExtraAmountForDeliveryeditor.commit();
    ...
    private void noService() {
        try {
            SharedPreferences Servicesforyourselectedcountryisnotavailablesp = getApplicationContext().getSharedPreferences(Config.SHARED_PREF78, 0);
            String Servicesforyourselectedcountryisnotavailable = Servicesforyourselectedcountryisnotavailablesp.getString("Servicesforyourselectedcountryisnotavailable","");

            AlertDialog.Builder builder= new AlertDialog.Builder(this);
            builder.setMessage(Servicesforyourselectedcountryisnotavailable+".")
                    .setCancelable(false)

...
public class AboutUsActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener,
    ...
    TextView feedBack,rateUs, aboutUs,privacyPolicy,termsAndCondition,aboutUsDescription,privacyPolicyDescription,
            termsAndConditionDescription,tvuser, tvcart, tv_notification, faq_description, faq,tv_header,tv_about,tv_technlgy;
    ...
    TextView tv_about_us_version,tv_about_us;
    String about_us_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with( this ).load( R.drawable.aboutgif ).into( imbanner );
        initiateViews();
        setRegViews();
        setBottomBar();
        getverstioncode();
       ...
       /* if(RequiredStorepref.getString("RequiredStore", null).equals("false")&&RequiredShoppinglistpref.getString("RequiredShoppinglist", null).equals("false")){
        ...
        SharedPreferences pref4 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF191, 0);
        tv_header.setText(pref4.getString("aboutus", null));

        SharedPreferences pref5 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF191, 0);
        tv_about.setText(pref5.getString("aboutus", null));

        SharedPreferences pref6 = getApplicationContext().getSharedPreferences(Config.SHARED_PREF229, 0);
        tv_technlgy.setText(pref6.getString("technologypartner", null));
    ...
    private void initiateViews() {
        ...
        tv_about_us_version=(TextView) findViewById(R.id.tv_about_us_version);
        tv_about_us =(TextView) findViewById(R.id.tv_about_us);
        tv_header=(TextView) findViewById(R.id.tv_header);
        tv_about=(TextView) findViewById(R.id.tv_about);
        tv_technlgy=(TextView) findViewById(R.id.tv_technlgy);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.etSearch:
                ...
                break;
            case R.id.imcart:
                Intent in = new Intent(AboutUsActivity.this, CartActivity.class);
                in.putExtra("From", "Home");
                startActivity(in);
                break;
            case R.id.tvcart:
                Intent i = new Intent(AboutUsActivity.this, CartActivity.class);
            ...
            case R.id.feedback:
                try {
                    ...
                    LayoutInflater inflater1 = (LayoutInflater) AboutUsActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AboutUsActivity.this, android.R.layout.simple_spinner_item, categories);
    ...
    private void setHomeNavMenu() {
        ...
        NavMenuAdapter adapter = new NavMenuAdapter(AboutUsActivity.this, menulist, imageId);
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(AboutUsActivity.this, OrdersActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 3) {
                    startActivity(new Intent(AboutUsActivity.this, FavouriteActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }  else if (position == 4) {
                    startActivity(new Intent(AboutUsActivity.this, FavouriteStoreActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 5) {
                    startActivity(new Intent(AboutUsActivity.this, NotificationActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 6) {
                    startActivity(new Intent(AboutUsActivity.this, ShoppingListActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }else if (position == 7) {
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(AboutUsActivity.this, TermsnConditionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 12) {
                    startActivity(new Intent(AboutUsActivity.this, PrivacyActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 13) {
                    startActivity(new Intent(AboutUsActivity.this, SuggestionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 14) {
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(getResources().getString(R.string.app_name).equals("JZT CART") || getResources().getString(R.string.app_name).equals("Pulikkottil Hypermarket") || getResources().getString(R.string.app_name).equals("NeethiMed")|| getResources().getString(R.string.app_name).equals("Touch n Buy")) {
                        ...
                        startActivity(new Intent(AboutUsActivity.this,SplashActivity.class));
                        finish();}
                    else{
                        startActivity(new Intent(AboutUsActivity.this,LocationActivity.class));
                        finish();}
    ...
    protected void sendEmail() {
        ...
        Toast.makeText(AboutUsActivity.this, Sendmail+"", Toast.LENGTH_SHORT).show();        String[] TO = {"touchnbuysupport@gmail.com"};
...
//            String version = pInfo.versionName;
            ...
            tv_about_us_version.setText(versioncode.getString("versioncode", null)+" : "+versionCode);

//            tv_about_us_version.setText(": "+versionCode);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
        }

        SharedPreferences aboutus = getApplicationContext().getSharedPreferences(Config.SHARED_PREF_ABOUT_US, 0);
        about_us_value = aboutus.getString("AboutUs",null);
        if (about_us_value!=null) {
            tv_about_us.setText(about_us_value);
        }
        ...
        public boolean onNavigationItemSelected( MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_category:
                    Intent io = new Intent(AboutUsActivity.this, OutShopActivity.class);
                ...
                case R.id.navigation_cart:
                    ...
                    Intent ic = new Intent(AboutUsActivity.this, CartActivity.class);
                ...
                case R.id.navigation_home:
                    ...
                    Intent iha = new Intent(AboutUsActivity.this, HomeActivity.class);
                    iha.putExtra(fromFavorite, valueFavorite);
                    startActivity(iha);
                    return true;
                case R.id.navigation_favorite:
                    Log.e(TAG,"navigation_favorite    ");
                    Intent ifa = new Intent(AboutUsActivity.this, FavouriteActivity.class);

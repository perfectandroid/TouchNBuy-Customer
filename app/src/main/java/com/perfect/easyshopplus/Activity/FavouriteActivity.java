...
import com.perfect.easyshopplus.Adapter.FavouritesAdapter;
...
public class FavouriteActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    DrawerLayout drawer;
    TextView tvuser,tv_nofavItems, tv_header, tvcart, tv_notification, store_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* SharedPreferences RequiredShoppinglistpref = getApplicationContext().getSharedPreferences(Config.SHARED_PREF45, 0);
        ...
        Glide.with( this ).load( R.drawable.emptyfavgif ).into( imLogo );
      ...
      //  PicassoTrustAll.getInstance(this).load(strImagepath1).into(imLogo);
        ...
        SharedPreferences Storesp = getApplicationContext().getSharedPreferences(Config.SHARED_PREF119, 0);
        String StoreName = pref1.getString("StoreName", "");
        if(StoreName.length() != 0) {
            store_tv.setText(Storesp.getString("Store","")+" : " + pref1.getString("StoreName", null));
        }

        SharedPreferences favouriteitems = getApplicationContext().getSharedPreferences(Config.SHARED_PREF189, 0);
        tv_header.setText(favouriteitems.getString("favouriteitems", null));

        SharedPreferences Thereisnofavouriteitemstoshow = getApplicationContext().getSharedPreferences(Config.SHARED_PREF345, 0);
        tv_nofavItems.setText(Thereisnofavouriteitemstoshow.getString("Thereisnofavouriteitemstoshow", null));
    ...
    private void initiateViews() {
        ...
        tv_nofavItems = (TextView) findViewById(R.id.tv_nofavItems);
    ...
    public void getAllfav(){
        db = new DBHandler(this);
        favlist = new ArrayList<>(db.getAllFav());
        try {
            Gson gson = new Gson();
            ...
            if(favlist.isEmpty()){
                ...
                FavouritesAdapter adapter = new FavouritesAdapter(this, jarray);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.etSearch:
                ...
                break;
            case R.id.imcart:
                Intent i = new Intent(FavouriteActivity.this, CartActivity.class);
                i.putExtra("From", "Home");
                startActivity(i);
                break;
            case R.id.tvcart:
                Intent in = new Intent(FavouriteActivity.this, CartActivity.class);
                in.putExtra("From", "Home");
                startActivity(in);
                break;
            case R.id.tv_notification:
                startActivity(new Intent(FavouriteActivity.this, NotificationActivity.class));
                break;
    ...
    private void setHomeNavMenu() {
        final String[] menulist = new String[]{"Home","My Cart", "My Orders","Favourite Stores",
                "Notifications", "Shopping List","My Profile", "About Us", "Logout", "Share"};
        Integer[] imageId = {
                R.drawable.ic_home,R.drawable.ic_cart, R.drawable.ic_order,R.drawable.ic_store,
        ...
        NavMenuAdapter adapter = new NavMenuAdapter(FavouriteActivity.this, menulist, imageId);
        ...
        lvNavMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(FavouriteActivity.this, OrdersActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }  else if (position == 3) {
                    startActivity(new Intent(FavouriteActivity.this, FavouriteStoreActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 4) {
                    startActivity(new Intent(FavouriteActivity.this, NotificationActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 5) {
                    startActivity(new Intent(FavouriteActivity.this, ShoppingListActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                } else if (position == 6) {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    try {
                        ...
                        LayoutInflater inflater1 = (LayoutInflater) FavouriteActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    startActivity(new Intent(FavouriteActivity.this, TermsnConditionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 11) {
                    startActivity(new Intent(FavouriteActivity.this, PrivacyActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 12) {
                    startActivity(new Intent(FavouriteActivity.this, SuggestionActivity.class));
                    drawer.closeDrawer(GravityCompat.START);
                }
                else if (position == 13) {
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(getResources().getString(R.string.app_name).equals("JZT CART") || getResources().getString(R.string.app_name).equals("Pulikkottil Hypermarket") || getResources().getString(R.string.app_name).equals("NeethiMed")|| getResources().getString(R.string.app_name).equals("Touch n Buy")) {
                        ...
                        startActivity(new Intent(FavouriteActivity.this,SplashActivity.class));
                        finish();}
                    else{
                        startActivity(new Intent(FavouriteActivity.this,LocationActivity.class));
                        finish();}
        ...
        public boolean onNavigationItemSelected( MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_category:
                    Intent io = new Intent(FavouriteActivity.this, OutShopActivity.class);
                ...
                case R.id.navigation_cart:
                    ...
                    Intent ic = new Intent(FavouriteActivity.this, CartActivity.class);
                    ic.putExtra(fromCart, valueCart);
                    startActivity(ic);
                    return true;
                case R.id.navigation_home:
                    Log.e(TAG,"navigation_home    ");
                    Intent ih = new Intent(FavouriteActivity.this, HomeActivity.class);
                    startActivity(ih);
                    return true;

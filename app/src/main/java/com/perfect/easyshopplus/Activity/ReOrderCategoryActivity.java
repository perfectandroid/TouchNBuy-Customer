...
import com.perfect.easyshopplus.Adapter.ReOrderCategoryAdapter;
...
public class ReOrderCategoryActivity extends AppCompatActivity implements View.OnClickListener {

    ProgressDialog progressDialog;
    RecyclerView rv_catlist;
    String ID_Store,MinimumDeliveryAmount, ShopType, ID_SalesOrder,ID_CustomerAddress,OrderType, DeliveryCharge,order_id,Id_order,orderDate,deliveryDate,status,itemcount,storeName,OrderNo;
    ImageView im;
                ...
                call.enqueue(new Callback<String>() {
                    @Override public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                        try {
                            ...
                            GridLayoutManager lLayout = new GridLayoutManager(ReOrderCategoryActivity.this, 3);
                            rv_catlist.setLayoutManager(lLayout);
                            rv_catlist.setHasFixedSize(true);
//                            ReOrderCategoryAdapter adapter = new ReOrderCategoryAdapter(ReOrderCategoryActivity.this, jarray,  ID_Store, ShopType, ID_SalesOrder,
//                                    OrderType,ID_CustomerAddress, DeliveryCharge);
                            ReOrderCategoryAdapter adapter = new ReOrderCategoryAdapter(ReOrderCategoryActivity.this, jarray, ID_SalesOrder, order_id, deliveryDate, Id_order, orderDate, status, ID_Store, ShopType,itemcount,ID_CustomerAddress,OrderType, storeName,DeliveryCharge,MinimumDeliveryAmount);
            ...
            Toast.makeText(getApplicationContext(),""+Somethingwentwrong.getString("Somethingwentwrong",""),Toast.LENGTH_LONG).show();
        }  }else {
        ...
        public boolean onNavigationItemSelected( MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_category:
                    Intent io = new Intent(ReOrderCategoryActivity.this, OutShopActivity.class);
                    io.putExtra(fromCategory, valueCategory);
                    finish();
                    startActivity(io);
                    return true;
//                case R.id.navigation_cart:
//                    Intent ic = new Intent(ReOrderCategoryActivity.this, CartActivity.class);
...
//                    return true;
                case R.id.navigation_home:
                    Intent iha = new Intent(ReOrderCategoryActivity.this, HomeActivity.class);
                    iha.putExtra(fromFavorite, valueFavorite);
                    startActivity(iha);
                    return true;
                case R.id.navigation_favorite:
                    Intent ifa = new Intent(ReOrderCategoryActivity.this, FavouriteActivity.class);
    ...
    private void showBackPopup() {
        try {
            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReOrderCategoryActivity.this);
            LayoutInflater inflater1 = (LayoutInflater) ReOrderCategoryActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

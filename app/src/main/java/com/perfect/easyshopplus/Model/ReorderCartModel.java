...
public class ReorderCartModel {
    ...
    public ReorderCartModel(){ }

    public ReorderCartModel(String ID_Items, String ItemName, String SalesPrice, String MRP, String Stock_ID, String QTY,
                            String RetailPrice, String PrivilagePrice, String WholesalePrice,
                            String GST, String CESS, String Count, String Packed, String Description, String ImageName) {

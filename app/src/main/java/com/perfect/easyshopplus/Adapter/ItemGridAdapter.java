...
public class ItemGridAdapter extends RecyclerView.Adapter {
    ...
    public ItemGridAdapter(Context context, JSONArray jsonArray, String ID_CategorySecond, String SecondCategoryName, String FirstCategoryName, String ID_CategoryFirst) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.activity_item_grid, parent, false);

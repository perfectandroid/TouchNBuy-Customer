...
public class ReOrderCategoryAdapter extends RecyclerView.Adapter {

    JSONArray jsonArray;
    JSONObject jsonObject=null;
    Context context;
//    String  ID_Store, ShopType, ID_SalesOrder,OrderType,ID_CustomerAddress, DeliveryCharge;
    String Id_order, orderDate,MinimumDeliveryAmount, deliveryDate, status,DeliveryCharge, order_id,OrderType,ID_CustomerAddress, ShopType, ID_Store, itemcount,ID_SalesOrder, storeName;

    public ReOrderCategoryAdapter(Context context, JSONArray jsonArray,
...
//                        .into(((MainViewHolder) holder).imCat);
                ...
                ((MainViewHolder)holder).lnLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                        jsonObject = jsonArray.getJSONObject(position);
                   /*     Intent intent = new Intent(context, ReOrderSubCategoryActivity.class);

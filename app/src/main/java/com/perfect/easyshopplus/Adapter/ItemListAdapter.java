...
public class ItemListAdapter extends RecyclerView.Adapter {
    ...
    public ItemListAdapter(Context context, JSONArray jsonArray, String ID_CategorySecond, String SecondCategoryName, String FirstCategoryName, String ID_CategoryFirst) {
        this.context=context;
        this.jsonArray=jsonArray;
        this.ID_CategorySecond=ID_CategorySecond;
                    ...
                    public void onClick(View v) {
                        ...
                        jsonObject = jsonArray.getJSONObject(position);
                            ...
                            if (SecondCategoryName.equals("")){
                                if (ID_CategorySecond.equals("00")){
                                    i.putExtra("from", "HomeItem");
                                }
                                else{
                                    i.putExtra("from", "HomeCatItem");
                                }
                            }
                            else {
                            ...
                            i.putExtra("ImageName",IMAGEURL + jsonObject.getString("ImageName")/* jsonObject.getString("ImageName")*/);
                        ...
                        try {
                            ...
                            if (!isFavorite) {
                                db.addtoFav(new FavModel(jsonObject.getString("ID_Items"), jsonObject.getString("ItemName"),
                                        ...
                                        , jsonObject.getString("GST"), jsonObject.getString("CESS"), jsonObject.getString("Packed"), jsonObject.getString("Description"),
                    ...
                    public void onClick(View v) {
                        ...
                        if (!isCart) {
                            db.addtoCart(new CartModel(jsonObject.getString("ID_Items"), jsonObject.getString("ItemName"), jsonObject.getString("SalesPrice"),jsonObject.getString("MRP"), jsonObject.getString("ID_Stock"), jsonObject.getString("CurrentStock"),
                                     jsonObject.getString("RetailPrice"), jsonObject.getString("PrivilagePrice"), jsonObject.getString("WholesalePrice")
                                    , jsonObject.getString("GST"), jsonObject.getString("CESS"),"1", jsonObject.getString("Packed"),
                                    jsonObject.getString("Description"), IMAGEURL + jsonObject.getString("ImageName"),jsonObject.getString("ItemMalayalamName")));

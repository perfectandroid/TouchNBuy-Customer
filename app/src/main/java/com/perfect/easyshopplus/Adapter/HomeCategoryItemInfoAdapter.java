...
public class HomeCategoryItemInfoAdapter extends RecyclerView.Adapter {
...
//    CartChangedListener cartChangedListener;
    ...
    public HomeCategoryItemInfoAdapter(Context context, JSONArray jsonArray) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.adapter_home_category_item_info, parent, false);
...
//                    ((MainViewHolder)holder).txtStock.setVisibility(View.VISIBLE);
                    ...
                    ((MainViewHolder)holder).ivCart.setVisibility(View.GONE);
                ...
                ((MainViewHolder)holder).lnLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            i.putExtra("from", "HomeOffer");
                            i.putExtra("ID_CategorySecond", "0");
                            i.putExtra("SecondCategoryName", "");
                            i.putExtra("FirstCategoryName", "");
                            i.putExtra("ID_CategoryFirst", "0");
